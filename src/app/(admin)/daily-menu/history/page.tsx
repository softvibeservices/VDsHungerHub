...
import { History, ArrowLeft, Pencil, ChevronLeft, ChevronRight, Sun, Moon } from "lucide-react";
      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 font-medium mt-0.5">
            Every menu you have ever published, with its dishes. Jump back in to review or edit any day.
          </p>
        </div>
      </div>
